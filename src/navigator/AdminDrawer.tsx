  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Examination',
        screen: screensName.ExaminationManagement,
        matchRoutes: [
          screensName.Examination,
          screensName.CreateTest,
          screensName.TestDetailsList,
          screensName.AssignQuestionList,
          screensName.ExaminationQuestionBank,
          screensName.ExaminationQuestionBankDetails,
          screensName.ExamResponse,
          screensName.TraineeResponseList,
          screensName.ExamResponseDetailsListTrainee,
          screensName.ExamResponseSheet,
        ],
      },
    ],
  },
    ...
    children: [
      {
        id: 'facility-hostel',
        name: 'Hostel',
        screen: screensName.Hostel,
        matchRoutes: [
          screensName.HostelManagement,
          screensName.HostelDetails,
          screensName.AddHostelDetails,
          screensName.FloorDetails,
          screensName.AddFloorDetails,
          screensName.RoomDetails,
          screensName.AddRoomDetails,
          screensName.BedDetails,
          screensName.AddBedDetails,
          screensName.HostelAllocation,
          screensName.HostelAllocationDetails,
          screensName.EditTraineeHostelAllocation,
          screensName.EditGuestHostelallocation,
          screensName.HostelAllocationHistory,
          screensName.TrainneHostelAllocationDetails,
          screensName.BedAvailability,
          screensName.Guest,
          screensName.AddGuest,
        ],
      },
      {
      ...
      },
      {
        id: 'facility-mess',
        name: 'Mess',
        screen: screensName.MessManagement,
        matchRoutes: [
          screensName.MessMaster,
          screensName.ItemBrand,
          screensName.AddItemBrand,
          screensName.ItemType,
          screensName.AddItemType,
          screensName.Item,
          screensName.AddItem,
          screensName.StockDetails,
          screensName.Stock,
          screensName.AddStock,
          screensName.StockConsumption,
          screensName.AddStockConsumption,
          screensName.MessReport,
          screensName.StockReportMess,
          screensName.StockReportDetails,
          screensName.MessFeedbackResponse,
          screensName.MessFeedbackResponseDetails,
        ],
      },
      {
      ...
      },
      {
        id: 'facility-vehicle',
        name: 'Vehicle',
        screen: screensName.VehicleManagement,
        matchRoutes: [
          screensName.AssignVehicle,
          screensName.DriverMovementHistory,
          screensName.AddAssignVehicle,
          screensName.CreateTour,
          screensName.CreateTourDetails,
          screensName.AddCreateTour,
        ],
      },
    ],
  },
