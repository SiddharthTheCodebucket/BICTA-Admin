...
const Assignment = (props: Props) => {
  ...
  return (
    <SafeAreaView edges={['bottom']} style={styles.container}>
      <TopTabs.Navigator
        tabBar={tabBarProps => <CustomAssignmentTabBar {...tabBarProps} />}
        screenOptions={{
          swipeEnabled: true,
          sceneStyle: {
      ...
      >
        ...
        <TopTabs.Screen
          ...
          initialParams={{ suppressHeader: true }}
          options={{ tabBarLabel: strings.assignment.assignQuestion }}
        />
        <TopTabs.Screen
