...
import VendorEmployeeMangement from './VendorEmployeeMangement';
...
const HRMS = (props: Props) => {
  ...
  const initialRouteName = useMemo(() => {
    ...
    if (initialTab === 'LeaveManagement') return 'LeaveManagementTab';
    return 'VendorEmployeeTab';
  ...
  return (
    <SafeAreaView edges={['bottom']} style={styles.container}>
      <TopTabs.Navigator
        ...
        tabBar={tabBarProps => <CustomHRMSTabBar {...tabBarProps} />}
        screenOptions={{
          swipeEnabled: true,
          sceneStyle: {
      ...
      >
        <TopTabs.Screen
          name="VendorEmployeeTab"
          component={VendorEmployeeMangement}
          initialParams={{ suppressHeader: true }}
          options={{ tabBarLabel: 'Vendor Employee Management' }}
        />
        <TopTabs.Screen
          name="LeaveManagementTab"
          component={LeaveManagement}
          initialParams={{ suppressHeader: true }}
          options={{ tabBarLabel: 'Leave Management' }}
        />
      </TopTabs.Navigator>
    </SafeAreaView>
  );
