    ...
    <ViewAtom style={styles.card}>
      ...
      <View style={styles.rowBetween}>
        ...
        <View style={{ flex: 1, alignSelf: 'flex-end' }}>
          <TextAtom style={styles.labelRight}>{'Item Name'}</TextAtom>
      ...
      <View style={styles.rowBetween}>
        ...
        <View style={{ flex: 1, alignSelf: 'flex-end' }}>
          <TextAtom style={styles.labelRight}>{'Item Type'}</TextAtom>
          <TextAtom numberOfLines={0} style={styles.valueRight}>
            {item.itemTypeName ?? '-'}
          </TextAtom>
        </View>
      ...
      <View style={styles.rowBetween}>
        <View style={{ flex: 1 }}>
          <TextAtom style={styles.label}>{'Unit'}</TextAtom>
          <TextAtom numberOfLines={0} style={styles.value}>
      ...
      <View style={styles.rowBetween}>
        ...
        <View style={{ flex: 1, alignSelf: 'flex-end' }}>
          <TextAtom style={styles.labelRight}>{'Total Value (₹)'}</TextAtom>
          <TextAtom numberOfLines={0} style={styles.valueRight}>
