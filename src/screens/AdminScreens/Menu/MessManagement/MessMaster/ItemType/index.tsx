      ...
      <View style={[styles.rowBetween, { marginBottom: vh(10) }]}>
        ...
        <View style={styles.actionRow}>
          <TouchableAtom
            ...
            onPress={() =>
              navigation.navigate(screensName.AddItemType, {
                item,
                onDone: onRefresh,
              })
            }
...
const ItemType = (props: Props) => {
  ...
  const [listApi] = useMessManagementListItemTypeMutation();
  const [deleteApi] = useMessManagementDeleteItemTypeMutation();
  ...
  useLayoutEffect(() => {
    Header.setNavigation(navigation, 'Item Type');
