  ...
  const RoomCard = ({ item, index, navigation }: any) => {
    ...
    const onSelectRoomType = (roomType: string) => {
      ...
      navigation.navigate(screensName.AlertOrganism, {
        ...
        cancelText: strings.cancel,
        okFunction: () => {
          updateRoomTypeStatus(item.id);
        },
        cancelFunction: () => {},
      });
    };

    const updateRoomStatus = (id: any) => {
      setInitialCall(true);
      const params = {
    ...
    const updateRoomTypeStatus = (id: any) => {
      setInitialCall(true);
      const params = {
        idForChangeRoomType: id,
      };
      updateHostelRoomApi(params)
        .unwrap()
        .then((res: any) => {
