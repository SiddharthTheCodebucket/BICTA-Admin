...
const BedDetailsList = (props: Props) => {
  ...
  const handleDelete = (item: any) => {
    navigation.navigate(screensName.AlertOrganism, {
      ...
      okFunction: () => deleteBedHostelRoom(item.id),
      cancelFunction: () => {},
    });
  };
  ...
  const BedCard = ({ item, index, navigation }: any) => {
    ...
    const bedTitle = `${item.selectRoomNo ?? '-'}, ${item.bedName ?? '-'}`;
        ...
        {isExpanded && (
          <View style={styles.accordionContent}>
            <View style={globalStyles.infoRow}>
              ...
              />
              <InfoField
                label={strings.hostelManagement.roomDetails.roomNo}
                value={item.selectRoomNo}
              />
            </View>

            <View style={globalStyles.infoRow}>
              <InfoField
                label={strings.hostelManagement.bedDetails.bedName}
                value={item.bedName}
              />
