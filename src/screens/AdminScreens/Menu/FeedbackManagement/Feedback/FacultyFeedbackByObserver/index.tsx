...
const FacultyFeedbackByObserver = (props: Props) => {
  ...
  const listTrainingDetais = (
    ...
    const params: any = {
      ...
      filters: [['userType', '=', 'CLASS OBSERVER']],
      pageNo: pageNumber,
  ...
  const TraineeCard = ({ item, index }: any) => {
    ...
    return (
      <TouchableAtom
        onPress={() => {
          navigation.navigate(screensName.FacultyFeedbackByObserverDetails, {
            data: item,
          });
        }}
        style={[styles.card]}
      >
        ...
        <View style={{ flex: 1 }}>
          <TextAtom style={styles.label}>Training Name (ID)</TextAtom>
          <TextAtom numberOfLines={0} style={styles.value}>
            {item.trainingName}({item.trainingId})
          </TextAtom>
        </View>
        <View style={{ flex: 1 }}>
          <TextAtom style={styles.label}>Faculty Name (ID)</TextAtom>
          <TextAtom style={styles.value}>
            {item.facultyName}({item.facultyId})
          </TextAtom>
        </View>
        <View style={{ flex: 1 }}>
          <TextAtom style={styles.label}>Observer name (ID)</TextAtom>
          <TextAtom style={styles.value}>
            {item.observerName}({item.observerId})
          </TextAtom>
        </View>
...
export default FacultyFeedbackByObserver;
