...
const FacultyClassApproveList = (props: Props) => {
    ...
    return (
      ...
      >
        ...
        <View style={globalStyles.infoRow}>
          <View style={globalStyles.infoCol}>
            <TextAtom style={globalStyles.infoLabel}>
              {strings.lms.classRoomManagement.subject || 'Subject'}
            </TextAtom>
          ...
          <View style={globalStyles.infoCol}>
            <TextAtom style={globalStyles.infoLabel}>
              {strings.lms.classRoomManagement.topic || 'Topic'}
            </TextAtom>
            <TextAtom style={globalStyles.infoValue}>
              {item.topicName || '-'}
            </TextAtom>
        ...
        <View style={globalStyles.infoRow}>
          <View style={globalStyles.infoCol}>
            <TextAtom style={globalStyles.infoLabel}>
              {strings.lms.classRoomManagement.faculty || 'Faculty'}
            </TextAtom>
            <TextAtom style={globalStyles.infoValue}>
              {item.facultyName || '-'}
            </TextAtom>
        ...
        <View style={globalStyles.infoRow}>
          ...
          <View style={globalStyles.infoCol}>
            ...
            <FormSwitchForCard
              title=""
              titleStyle={{ height: 0, margin: 0, padding: 0 }}
              data={[
  ...
  return (
    <SafeAreaView edges={['bottom']} style={styles.container}>
      ...
      <View style={{ paddingHorizontal: vw(15) }}>
        <AdminListHeader
          config={{
            title: strings.lms.classRoomManagement.facultyClassApprove,
            search: {
              visible: true,
              onPress: () => {
            ...
            create: {
              visible: true,
              onPress: () => {
                // No apecific add screen found in screensName.ts
              },
            },
            filter: {
              visible: false,
      ...
      <View style={{}}>
        <SubTab
          ...
          tabs={[
            ...
            {
              value:
                strings.lms.classRoomManagement.previousTraining || 'previous',
              label:
...
export default FacultyClassApproveList;
