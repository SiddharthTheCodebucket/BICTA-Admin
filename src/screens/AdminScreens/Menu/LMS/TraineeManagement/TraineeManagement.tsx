...
import TraineeRegistration from '../TraineeManagement/TraineeRegistration';
import TraineeDetails from '../TraineeManagement/TraineeDetails';
import OthersRegistration from '../TraineeManagement/OthersRegistration';
import TraineeRelease from '../TraineeManagement/TraineeRelease';
    ...
    <SafeAreaView edges={['bottom']} style={styles.container}>
      ...
      >
        ...
        <TopTabs.Screen
          ...
          options={{ tabBarLabel: 'Others Registration' }}
        />
        <TopTabs.Screen
          name="TraineeRelease"
